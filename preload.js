...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  snapchatWarrantLoadData: (data) => ipcRenderer.invoke('snapchat-warrant-load-data', data),
  snapchatWarrantSaveData: (data) => ipcRenderer.invoke('snapchat-warrant-save-data', data),
  snapchatWarrantDeleteData: (data) => ipcRenderer.invoke('snapchat-warrant-delete-data', data),
